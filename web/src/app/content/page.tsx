...
import {
  CONTENT, ContentItem, contentTone, platIcon, brandOverview,
...
export default function ContentPage() {
  ...
  const items = CONTENT.filter((c) => brand === "all" || c.b === brand);
  const cards = brandOverview();
  ...
  return (
    <>
      <PageHeader
        ...
        right={<button className="text-[13px] font-bold text-white bg-panel rounded-[10px] px-4 py-[9px]">+ New Post</button>}
      />
