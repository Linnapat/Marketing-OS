...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([fetchCampaigns(), fetchBudgetSheetRows()]).then(([campaigns, sheetRows]) => {
      if (!alive) return;
      const year = currentBudgetYearKey();
      const budgetTotals = annualBudgetByBrandFromSheet(sheetRows, year);
                ...
                <div key={b.key} className="bg-surface border border-line rounded-cardLg p-5">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    ...
                    <div className="bg-ivory border border-line3 rounded-card p-2 text-center">
                      ...
                      <div className="text-[9.5px] text-faint font-bold uppercase">PL budget · {budgetYear}</div>
                    </div>
                  </div>
