...
export function ContentItemForm({ item, onChange, outOfRange }: {
  ...
  return (
    <div className="grid md:grid-cols-2 gap-3">
      ...
      <div className="md:col-span-2 mt-1 pt-3 border-t border-line3 grid md:grid-cols-2 gap-3">
        ...
        <div><label className={label}>Reference Brief Link <span className="text-status-red">*</span></label><input value={item.referenceBriefLink} onChange={(e) => onChange({ referenceBriefLink: e.target.value })} className={field} placeholder="https://…" /></div>
