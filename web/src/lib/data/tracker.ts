/* Work Tracker — แคมเปญ → โพสต์ → งาน Graphic/VDO ในต้นไม้เดียว
 *
 * ทำไมต้องมีหน้านี้ ทั้งที่มี Status Dashboard อยู่แล้ว:
 *
 * Status Dashboard วาง Content กับ Graphic ไว้คนละ lane ใต้แคมเปญเดียวกัน
