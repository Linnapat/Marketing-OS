...
export interface Task {
  ...
  graphicSlot?: "artwork" | "shoot" | "storyboard" | "rush" | "retouch";
...
export const TASKS: Task[] = [
  ...
  { id: 3, title: "Approve summer reel final design", module: "Graphic", moduleIcon: "🎨", moduleColor: "#C2691E", type: "Graphic", assignee: "Aran P.", brand: "Omakase", campaign: "Summer Reel Series", status: "Need Approval", priority: "High", group: "needApproval", due: "Jul 2", blocker: null, pendingApprover: "Aran P.", isQuickWin: false, nextAction: "Design is ready. Approve or request revision.", checklist: ["Check CI alignment", "Check copy", "Approve"], relatedGraphicId: "9" },
  ...
  { id: 9, title: "Wagyu key visual — Revision 2", module: "Graphic", moduleIcon: "🎨", moduleColor: "#C2691E", type: "Graphic", assignee: "Boss", brand: "Teppen", campaign: "Wagyu Festival", status: "In Progress", priority: "High", group: "doFirst", due: "Jul 2", blocker: null, pendingApprover: "Aran P.", isQuickWin: false, nextAction: "Apply revision notes from Aran. Upload V2 by 5pm today.", checklist: ["Apply copy change", "Fix logo size", "Upload V2 link"], relatedGraphicId: "3" },
  { id: 10, title: "Menu redesign — Touka cocktail hour", module: "Graphic", moduleIcon: "🎨", moduleColor: "#C2691E", type: "Graphic", assignee: "Boss", brand: "Touka", campaign: "Cocktail Hour Launch", status: "Revision", priority: "High", group: "doFirst", due: "Jul 3", blocker: null, pendingApprover: "Ploy R.", isQuickWin: false, nextAction: "Revision notes received from Ploy. Update layout and submit V3.", checklist: ["Update layout", "Recheck copy", "Export all sizes"], relatedGraphicId: "8" },
  { id: 11, title: "Father's Day promotional banner", module: "Graphic", moduleIcon: "🎨", moduleColor: "#C2691E", type: "Graphic", assignee: "Boss", brand: "Omakase", campaign: "Father's Day Set", status: "Waiting", priority: "Med", group: "waitingMe", due: "Jul 3", blocker: "Ken S. — copy not confirmed", pendingApprover: "Ken S.", isQuickWin: false, nextAction: "Waiting for confirmed copy from Ken before design can start.", checklist: [], relatedGraphicId: "6" },
