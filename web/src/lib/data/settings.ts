...
export const INTEGRATIONS = [
  ...
  { icon: "💼", iconBg: "#EEF1F8", name: "Slack", category: "Messaging", desc: "แจ้งเตือนงานเข้าห้องของแต่ละทีม — Graphic + Content, KOL, VDO · งานทั่วไปและเรื่องเงินส่งเป็น DM ไม่เข้าห้อง", status: "Not connected", lastSync: "—", actions: ["Connect"] },
