 ...
 *  that away. */
export function giveLensVerdict({ g, deliverables, index, lens, verdict, me, note, creativeLeader, cmoName, ciBackup, productionOwners, onUpdate }: {
  g: Graphic;
  ...
  cmoName?: string;
  /** Senior Graphic Designers, asked for CI before the CMO is pulled in. */
  ciBackup?: string[];
